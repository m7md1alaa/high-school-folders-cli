export const subjectsByTrack = {
  ...
  second: {
    ...
    shariah: {
      ...
      Semester_3: [
        { en: "Tawhid", ar: "التوحيد" },
        { en: "Holy Quran", ar: "القرآن الكريم" },
        { en: "Quranic Studies", ar: "الدراسات القرآنية" },
        { en: "Linguistic Studies", ar: "الدراسات اللغوية" },
        { en: "Quran Interpretation", ar: "تفسير القرآن" },
        { en: "Arts", ar: "الفنون" },
        { en: "English", ar: "اللغة الإنجليزية" },
  ...
  third: {
    general: {
      Semester_1: [
        { en: "Chemistry", ar: "الكيمياء" },
        { en: "Research and Information Sources", ar: "البحث ومصادر المعلومات" },
        { en: "English", ar: "اللغة الإنجليزية" },
      ...
      Semester_3: [
        ...
        { en: "Mathematics", ar: "الرياضيات" },
        { en: "Physics", ar: "الفيزياء" },
        { en: "Psychological and Social Studies", ar: "الدراسات النفسية والاجتماعية" },
        { en: "Earth and Space Sciences", ar: "علوم الأرض والفضاء" },
        { en: "Elective", ar: "اختياري" },
        { en: "Itqan", ar: "إتقان" },
      ],
    ...
    cs: {
      ...
      Semester_2: [
        ...
        { en: "AI", ar: "الذكاء الاصطناعي" },
        { en: "Engineering Design", ar: "تصميم الهندسة" },
        { en: "Life Skills", ar: "مهارات الحياة" },
      ],
      Semester_3: [
    ...
    health: {
      Semester_1: [
        ...
        { en: "Health Sciences (Innovation)", ar: "علوم الصحة (الابتكار)" },
      ...
      Semester_3: [
        ...
        { en: "Mathematics (3-3)", ar: "الرياضيات (3-3)" },
        { en: "Physics (3-3)", ar: "الفيزياء (3-3)" },
        { en: "Statistics (Applications in Health)", ar: "الإحصاء (تطبيقات في الصحة)" },
        { en: "Earth and Space Sciences", ar: "علوم الأرض والفضاء" },
        { en: "Project Graduation", ar: "مشروع التخرج" },
        { en: "Itqan", ar: "إتقان" },
      ],
    ...
    business: {
      Semester_1: [
        { en: "Literary Studies", ar: "الدراسات الأدبية" },
        { en: "Statistics (Applications in Business)", ar: "الإحصاء (تطبيقات في الأعمال)" },
        { en: "English", ar: "اللغة الإنجليزية" },
        { en: "Tawhid", ar: "التوحيد" },
      ...
      Semester_2: [
        { en: "Secretarial and Office Management", ar: "إدارة المكاتب والأمانة" },
      ...
      Semester_3: [
        { en: "Arabic Language - Critical Rhetoric", ar: "اللغة العربية - البلاغة النقدية" },
        { en: "Principles of Accounting (2-1)", ar: "مبادئ المحاسبة (2-1)" },
        { en: "English (3-3)", ar: "اللغة الإنجليزية (3-3)" },
        { en: "Applications in Law", ar: "تطبيقات في القانون" },
        { en: "Psychological and Social Studies", ar: "الدراسات النفسية والاجتماعية" },
        { en: "Project Graduation", ar: "مشروع التخرج" },
        { en: "Applications in Entrepreneurship", ar: "تطبيقات في ريادة الأعمال" },
        { en: "Itqan", ar: "إتقان" },
      ],
    },
    shariah: {
